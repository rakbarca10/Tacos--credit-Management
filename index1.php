...
<body>
    ...
    <div id="welcome">
        <h1>Welcome to Tacos Credit Management Portal</h1>
    </div>

    <p id="chooseFrom">Choose one from the below options</p>

    
      
		<a href="index.php" class="myButton" style="margin:15px;">MAIN PAGE</a>
		  <div class="dropdown">
<button class="dropbtn">OPTIONS AVAILABLE!</button><br>
